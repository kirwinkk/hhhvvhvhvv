...
☮/say = teks ke suara
☮/lirik = Menunjukan Lirik
☮/instagram <username> = Cek Ig
☮/lagu <penyanyi> <judul>[Sedang Dalam Pembaruan]
☮/set > cek sider
...
Suport By:RisyadRmdhn

==>"Instagram.com/Risyadrmdhn_"<==
...
Bots=[mid,"ucda491efd8f6319bdf352f1cf84c849c"]
admin=["u4791058fc95094ef8cbb3b5f2b268509"]
wait = {
    'contact':False,
    'autoJoin':True,
...
def autolike():
     for zx in range(0,100):
	    ...
	    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AutoLike by Astronout Bot\n\nhttps://instagram.com/Risyadrmdhn_")
            print "Like"
          except:
            pass
        else:
            ...
            if mid in op.param3:
                ...
                if wait["autoJoin"] == True:
                    if wait["autoCancel"]["on"] == True:
                        ...
                        cl.acceptGroupInvitation(op.param1)
			cl.sendText(op.param1,"Terima Kasih Telah Mengundang Astronaut\n\nKetik [/Help] Untuk Command/Key Bot.")
...
#--------------------------------- TRANSLATE --------------------------------
	...
	#-----------KERANG---------#
    		...
    		jawab = ("Iya","Tidak","Mungkin","mungkin iya","mungkin tidak")
    		jawaban = random.choice(jawab)
		tts = gTTS(text=jawaban, lang='id')
		tts.save('tts.mp3')
    		cl.sendAudio(msg.to,'tts.mp3')
	...
	#-------------------------------#
		 ...
		 if msg.toType == 2:
 		 ...
 		 if msg.toType == 2:
			...
			cl.sendText(msg.to, "Ketik 「/set」 dulu Sat...\nDasar Pikun")
...
#-----------------------------------------------
                ...
                kc.sendText(msg.to,"Hinata pekok 􀜁􀅔Har Har􏿿")
					...
					msg.contentType = 13
					msg.contentMetadata = {'mid': "u4791058fc95094ef8cbb3b5f2b268509"}
					cl.sendMessage(msg)
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
                ...
                cl.sendText(msg.to,"Bot Ini Dibuat Oleh Risyad Pd tanggal 9November2017\nDengan Tujuan Menghibur Pengguna Line,\nBot Ini Memiliki Fitur Unik Sebagai Berikut\n~Cek Sider\n~Penghitung pahala(Fake)\n~Penghitung Dosa(fake)\n~Kerang Ajaib\n~Talk,dll\n\nJika Bot Ini Bermasalah Hubungi Creator:\n")
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
            elif msg.text in ["sp","Sp","Speedbot","speedbot"]:
		start = time.time()
      ...
      #-------------Fungsi Speedbot Finish---------------------#
                ...
                if len(arg) > 1:
                    ...
                    cl.sendText(msg.to,"Contoh /ig Risyadrmdhn")
