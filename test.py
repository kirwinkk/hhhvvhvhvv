...
cl = LINETCR.LINE()
cl.login(token="EnvlM13esO0QthKIoxl0.3FLXqaAHaqU2vr+bb+uJKa.pJ4l/2HWWFvL4ijdxdXvNvdYv/D/8aq2MlBe/Osu3yQ=")
cl.loginResult()
...
admin=["uc216d8664c4e1f43772c98b1b0b8956e","ubecd98a04cbf74a830b6c95b67bd6b74","udb100d34b3733cf8820982433a77d303"]
wait = {
    'contact':True,
    'autoJoin':True,
